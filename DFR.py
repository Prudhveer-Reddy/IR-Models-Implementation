...
def post(encoded_args,lang):
    inurl = 'http://ec2-13-58-86-116.us-east-2.compute.amazonaws.com:8983/solr/DFR/select?q='+encoded_args+'&defType=dismax&qf=text_en+text_de+text_ru&fl=id%2Cscore&wt=json&indent=true&rows=20'
    outfn = str(iter)+'.txt'
